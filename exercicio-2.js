 ...
 */
const getBioByIdFunctional = (id) => { var _a; return (_a = listProfile.find(item => item.id === id)) === null || _a === void 0 ? void 0 : _a.bio; };
/**
 ...
 */
const getNameByIdFunctional = (id) => { var _a; return (_a = listProfile.find(item => item.id === id)) === null || _a === void 0 ? void 0 : _a.name; };
/**
 ...
 */
const deleteItemByIdFunctional = (id) => listProfile.filter(item => item.id !== id);
/**
 * Apaga um item da lista dado seu ID - Forma Funcional.
 *
 * @param id - ID do perfil que vai ser apagado.
 ...
 */
const updateItemByIdFunctional = (id, newName, newBio) => {
    listProfile = listProfile.map(item => item.id === id ? Object.assign(Object.assign({}, item), { name: newName || item.name, bio: newBio || item.bio }) : item);
};
/**
